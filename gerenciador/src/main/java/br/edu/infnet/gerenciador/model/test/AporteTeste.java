...
public class AporteTeste {
	...
	public static void main(String[] args) {
		...
		Viagem v1 = new Viagem("Viagem para Machu Pichu", 10000, LocalDateTime.of(2023, 06, 01, 0, 0));
		v1.setDataViagem(LocalDateTime.of(2023, 07, 01, 0, 0));
		v1.setInternacional(true);
		v1.setQtdAcompanhantes(1);
		
		Viagem v2 = new Viagem("Viagem para Maceio", 5000, LocalDateTime.of(2022, 03, 01, 0, 0));
		...
		aporte.setUsuario(new Investidor("thafny", "thafny@teste.com", 27));
